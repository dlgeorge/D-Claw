...
def topoheaderread (inputfile, closefile=True):
    ...
    'xllcenter':'xll','yllcenter':'yll','xllcorner':'xll','yllcorner':'yll','xlower':'xll','ylower':'yll'}
...
def topofileinterpolate(inputfile,outputfile,lrat=None,xi=[],yi=[],topotype=2,kx=1,ky=1,s=0.0):
    ...
    griddata2topofile(Xi,Yi,Zi,outputfile,topotype,nodata_value_in=nodata_valuein,nodata_value_out=nodata_valuein)

#===============================================================================
def scatter2smoothgridded(outputfile,headerfile=None,xi=[],yi=[],inputfile=None,x=[],y=[],z=[],topotype=2,kx=3,ky=3,s=0):
...
#============================================================================================
def burnin_nodata_value (inputfile1,inputfile2,outputfile,topotypein1=3,topotypein2=3,topotypeout=None,\
        nodata_valuein=None):
    ...
    griddata2topofile(X,Y,Znew,outputfile,topotypeout,nodata_valuein,nodata_valuein)
...
#============================================================================================
def clip_surface (inputfile1,inputfile2,outputfile,topotypein1=3,topotypein2=3,topotypeout=None,\
        nodata_valuein=None):
    ...
    griddata2topofile(X2,Y2,Z2,outputfile,topotypeout,nodata_valuein,nodata_valuein)
